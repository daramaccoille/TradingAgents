...
# Tickers can contain letters, digits, dot, dash, underscore, caret, and equals sign
# (for index symbols like ^GSPC and futures like GC=F). Anything else is rejected so the value
